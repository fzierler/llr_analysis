...
metadata = pd.read_csv("metadata/runs_su3.csv")
...
rule all:
    input:
        ...
        out_critical="data_assets/su3/critical_beta_distribution.csv",
        out_ratios="data_assets/su3/critical_beta_ratios.csv",
